...
> **最後更新**: 2025-11-12
> **分析深度**: Medium
> **最後提交**: ebfb371 (SECURITY: Critical security fixes)
...
// 回傳
{
  "valid": false,
  "conflicts": [
    { type: "duplicate", person: "員工A", dates: [...] },
    { type: "overwork", person: "員工B", consecutiveDays: 6 }
  ]
}
```
